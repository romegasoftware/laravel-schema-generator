...
/**
 * Default Spatie Data configuration for Laravel Zod Generator package.
 * This provides sensible defaults when the user hasn't published their own data config.
 */
return [
    ...
    'structure_caching' => [
        'enabled' => false, // Disabled for package usage to avoid issues
