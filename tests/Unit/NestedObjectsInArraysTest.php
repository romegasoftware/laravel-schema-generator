...
class NestedObjectsInArraysTest extends TestCase
{
    ...
    public function it_handles_nested_objects_within_array_items(): void
    {
        ...
        $this->assertStringContainsString('lengthInSeconds: z.number({error: (val) => (val != undefined && val != null ? \'The songs.*.song meta data custom name.*.length in seconds field is required.\' : undefined)})', $schema);
